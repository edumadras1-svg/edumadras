      ...
      <main className="container-mobile py-10 px-4">
        ...
        <section className="mt-16 border-t border-gray-100 pt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { label: "Best Engineering Colleges AP", href: "/best-engineering-colleges-andhra-pradesh" },
              { label: "CSE Colleges in AP", href: "/cse-engineering-colleges-andhra-pradesh" },
              { label: "Private Engineering Colleges AP", href: "/private-engineering-colleges-andhra-pradesh" },
              { label: "Engineering Colleges Vizag", href: "/engineering-colleges-vizag" },
              { label: "Engineering Colleges Vijayawada", href: "/engineering-colleges-vijayawada" },
              { label: "Top 10 EAMCET Colleges AP", href: "/top-10-eamcet-engineering-colleges-ap" },
              { label: "Best Placement Colleges AP", href: "/engineering-colleges-ap-placement-records" },
              { label: "Average Packages AP Colleges", href: "/average-package-engineering-colleges-andhra-pradesh" },
              { label: "AP EAMCET College Predictor", href: "/ap-eamcet-rank-wise-college-predictor" },
              { label: "Tier 1 Engineering Colleges AP", href: "/tier-1-engineering-colleges-andhra-pradesh" },
              { label: "Andhra University B.Tech Review", href: "/andhra-university-engineering-college-review" },
              { label: "Highest Packages AP Colleges", href: "/highest-package-engineering-colleges-ap" },
              { label: "Mechanical Engineering AP", href: "/mechanical-engineering-colleges-ap" },
              { label: "Government vs Private AP", href: "/government-vs-private-engineering-colleges-ap" },
              { label: "KL University B.Tech Review", href: "/kl-university-engineering-review" },
              { label: "Choose Engineering College AP", href: "/how-to-choose-engineering-college-ap" },
              { label: "Direct Admission in AP Colleges", href: "/direct-admission-engineering-colleges-ap" },
              { label: "Colleges in Kadapa & Rayalaseema", href: "/engineering-colleges-kadapa-rayalaseema" },
              { label: "M.Tech Data Science & AI AP", href: "/mtech-data-science-ai-colleges-ap" },
              { label: "Internship Opportunities AP", href: "/engineering-internship-opportunities-ap" },
              { label: "IT Colleges in AP", href: "/it-engineering-colleges-andhra-pradesh" },
              { label: "ECE Colleges in AP", href: "/ece-engineering-colleges-andhra-pradesh" },
              { label: "Engineering College Fees AP", href: "/engineering-college-fees-andhra-pradesh" },
              { label: "Campus Life AP Colleges", href: "/engineering-college-campus-life-ap" },
              { label: "Is Engineering Good in AP?", href: "/is-engineering-good-career-andhra-pradesh" },
              { label: "AP vs National Rankings", href: "/ap-engineering-colleges-national-rankings-comparison" },
              { label: "Scholarships AP Engineering", href: "/scholarship-opportunities-ap-engineering-colleges" },
              { label: "100% Placement Colleges Chennai", href: "/100-percent-placement-colleges-chennai" },
              { label: "Web Dev Colleges Chennai", href: "/web-development-colleges-chennai" },
              { label: "IT Recruiters Chennai Colleges", href: "/top-it-companies-recruiting-chennai-colleges" },
              { label: "Average Placements in Chennai", href: "/average-placement-package-chennai-colleges" },
              { label: "Tier 1 vs Tier 2 Chennai", href: "/tier-1-vs-tier-2-colleges-chennai" },
              { label: "Verify College Placement Data", href: "/how-to-verify-college-placement-data" },
              { label: "Coding Skills vs College Name", href: "/coding-skills-vs-college-name-jobs" },
              { label: "Placement Tips Tier 2 Colleges", href: "/placement-tips-tier-2-colleges-chennai" },
              { label: "Deemed Universities Job Prospects", href: "/deemed-universities-chennai-job-prospects" },
              { label: "SSN vs SVCE Comparison", href: "/ssn-vs-svce-colleges-chennai" },
              { label: "Anna University vs Private Placements", href: "/anna-university-vs-private-colleges-placement" },
              { label: "Hindustan University placements", href: "/hindustan-university-placements-salary" },
              { label: "Hindustan University admission", href: "/hindustan-university-admission-process" },
              { label: "HITS courses & placements", href: "/hindustan-university-courses-placements" },
              { label: "Student Freelancing HITS", href: "/freelancing-while-studying-hindustan-university" },
              { label: "Engineering to Design Transition", href: "/transition-engineering-to-digital-design" },
              { label: "Employer In-demand Skills India", href: "/engineering-skills-employer-demands-india" },
              ...
              { label: "Top 20 Engineering Colleges Chennai", href: "/top-20-engineering-colleges-chennai" },
              ...
              { label: "Mechanical Colleges Chennai", href: "/mechanical-engineering-colleges-chennai" },
              { label: "ECE Colleges Chennai", href: "/ece-colleges-chennai" },
              { label: "EEE Colleges Chennai", href: "/eee-colleges-chennai" },
              { label: "Civil Colleges Chennai", href: "/civil-engineering-colleges-chennai" },
              ...
              { label: "Top Engineering Colleges Coimbatore", href: "/top-engineering-colleges-coimbatore" },
