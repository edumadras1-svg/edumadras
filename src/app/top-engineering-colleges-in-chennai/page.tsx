...
const PAGE_URL = "https://www.edumadras.com/top-engineering-colleges-in-chennai";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.edumadras.com/top-engineering-colleges-in-chennai" },
  openGraph: { title: "Top Engineering Colleges in Chennai 2025 | EduMadras", url: "https://www.edumadras.com/top-engineering-colleges-in-chennai", siteName: "EduMadras", type: "website", locale: "en_IN" },
};
...
export default async function Page() {
  ...
  return (
    <>
      ...
      <SEOCollegeListing colleges={colleges} title="Top Engineering Colleges in Chennai" h1={H1} subtitle="Comprehensive guide to Chennai's finest engineering institutions — ranked by NIRF, placements & academic excellence." introText="Chennai, the engineering education hub of South India, houses some of the country's most prestigious technical institutions. From IIT Madras — India's #1 ranked engineering college — to top private universities like SRM and VIT Chennai, the city offers unmatched opportunities for aspiring engineers. This page provides a complete, data-driven comparison of all top engineering colleges in Chennai to help you make the best choice for your career." breadcrumbs={BREADCRUMBS} faqItems={FAQ_ITEMS} pageUrl="https://www.edumadras.com/top-engineering-colleges-in-chennai" />
    </>
  );
}
