...
const PAGE_URL = "https://www.edumadras.com/top-engineering-colleges-tamilnadu";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.edumadras.com/top-engineering-colleges-tamilnadu" },
  openGraph: { title: "Top Engineering Colleges in Tamil Nadu 2025 | EduMadras", url: "https://www.edumadras.com/top-engineering-colleges-tamilnadu", siteName: "EduMadras", type: "website", locale: "en_IN" },
};
...
export default async function Page() {
  ...
  return (
    <>
      ...
      <SEOCollegeListing colleges={colleges} title="Top Engineering Colleges in Tamil Nadu" h1={H1} subtitle="Complete rank-wise directory of Tamil Nadu's best engineering colleges with NIRF rankings, fees & placement data." introText="Tamil Nadu is one of India's strongest states for technical education, with IIT Madras, NIT Trichy, and Anna University leading the way. The state's TNEA counseling process makes engineering admissions transparent and merit-based. This comprehensive guide covers all top engineering colleges across Tamil Nadu — from Chennai to Coimbatore, Madurai to Trichy — with verified data to help you choose the right institution." breadcrumbs={BREADCRUMBS} faqItems={FAQ_ITEMS} pageUrl="https://www.edumadras.com/top-engineering-colleges-tamilnadu" />
    </>
  );
}
